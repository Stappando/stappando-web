...
const EXTERNAL_LINKS = [
  { href: 'https://app.vineis.eu', label: 'Esperienze', icon: 'M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3zM6 6.75a.75.75 0 11-1.5 0 .75.75 0 011.5 0z', color: '#005667' },
  { href: 'https://anbrekabol.com', label: 'Cartoni spedizione', icon: 'M21 7.5l-2.25-1.313M21 7.5v2.25m0-2.25l-2.25 1.313M3 7.5l2.25-1.313M3 7.5l2.25 1.313M3 7.5v2.25m9 3l2.25-1.313M12 12.75l-2.25-1.313M12 12.75V15m0 6.75l2.25-1.313M12 21.75V15m0 0l-2.25-1.313M3 16.5v2.25m0-2.25l2.25 1.313M21 16.5l-2.25 1.313M21 16.5v2.25', color: '#8B4513' },
];
