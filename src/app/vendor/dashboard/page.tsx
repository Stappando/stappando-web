...
export default function VendorDashboard() {
  ...
  // Customer logged in but NOT vendor — show pending approval
  return (
    <div className="min-h-[70vh] flex items-center justify-center px-4">
      {/* Blurred background */}
      <div className="fixed inset-0 z-0">
        <div className="absolute inset-0 bg-gradient-to-br from-[#f8f6f1] to-[#e8e4dc]" />
      ...
      <div className="relative z-10 bg-white rounded-2xl shadow-2xl max-w-md w-full p-8 text-center">
        ...
        <h1 className="text-[22px] font-bold text-[#1a1a1a] mb-3">
          Stiamo preparando il tuo negozio
        </h1>

        <p className="text-[15px] text-[#666] leading-relaxed mb-6">
          Grazie per la tua registrazione, <strong className="text-[#1a1a1a]">{user?.firstName || ''}</strong>!<br />
        ...
        <div className="bg-[#f8f6f1] rounded-xl p-5 mb-6 text-left">
          ...
          {[
            { n: '1', text: 'Verifica dei dati aziendali', done: true },
            { n: '2', text: 'Configurazione del tuo negozio', done: false },
            { n: '3', text: 'Approvazione e attivazione', done: false },
          ].map(step => (
