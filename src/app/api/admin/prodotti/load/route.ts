...
export async function GET(req: NextRequest) {
  ...
  try {
    ...
    const data = {
      ...
      abbinamenti: getAttrMulti('Abbinamento') || getAttrMulti('Abbinamenti'),
      temperaturaServizio: getAttr('Servire a') || getAttr('Temperatura di servizio'),
      ...
      terreno: getAttrMulti('Terreno') || getMeta('terreno'),
      esposizione: getMeta('esposizione'),
      altitudine: getAttr('Altitudine dei vigneti') || getMeta('altitudine'),
      zonaProduzione: getAttr('Zona di produzione') || getMeta('zona_produzione'),
      resa: getAttr('Resa'),
      raccolta: getAttr('Raccolta'),
      periodoVendemmia: getAttrMulti('Periodo vendemmia'),
      bottiglieProdotte: getAttr('Bottiglie prodotte') || getMeta('bottiglie_prodotte'),
