...
function generatePreviews(): { id: string; title: string; html: string }[] {
  return [
    ...
    {
      id: 'fiere-presentazione-cold',
      title: '18b. Presentazione cold — senza fiera',
      html: buildFiereEmail({ cold: true }),
    },
    { id: 'followup-1', title: '19. Follow-up 1 (+5gg)', html: fiereFollowUp1('Mario').html },
    { id: 'followup-2', title: '20. Follow-up 2 (+12gg)', html: fiereFollowUp2('Mario').html },
    { id: 'followup-3', title: '21. Follow-up 3 (+20gg)', html: fiereFollowUp3('Mario').html },
    { id: 'followup-4', title: '22. Follow-up 4 (+28gg)', html: fiereFollowUp4('Mario').html },
    { id: 'followup-5', title: '23. Follow-up 5 (+35gg)', html: fiereFollowUp5('Mario').html },
    { id: 'followup-6', title: '24. Follow-up 6 (+42gg)', html: fiereFollowUp6('Mario').html },
    { id: 'followup-7', title: '25. Follow-up 7 (+50gg)', html: fiereFollowUp7('Mario').html },
    { id: 'followup-8', title: '26. Follow-up 8 (+58gg)', html: fiereFollowUp8('Mario').html },
  ];
}

function buildFiereEmail(opts?: { cold?: boolean }): string {
  const openingParagraph = opts?.cold
    ? `Sono Roberto di stappando.it, un gruppo che lavora nel mondo del vino. Vorrei capire se può nascere una collaborazione con voi. Chi siamo?`
  ...
  const firma = opts?.cold ? 'Roberto' : 'Roberto';
  return `<!DOCTYPE html>
<html lang="it">
