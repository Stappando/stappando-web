...
const OCCASIONS_DESKTOP = [
  { label: 'Aperitivo', href: '/cerca?q=Aperitivi', bg: '#005667', color: '#fff' },
  { label: 'Tutti i giorni', href: '/cerca?max_price=8', bg: '#3D2B1A', color: '#e8ddd0' },
  { label: 'Scorta', href: '/cerca?q=Confezione+da+6', bg: '#2C2C2A', color: '#d3d1c7' },
  { label: 'Regalo', href: '/cerca?tag=regali', bg: '#5C3317', color: '#f0e0d0' },
  { label: 'Spumanti', href: '/cerca?q=Spumanti', bg: '#d9c39a', color: '#3D2B1A' },
  { label: 'Vini Bianchi', href: '/cerca?q=Vini+Bianchi', bg: '#8B9D83', color: '#fff' },
...
const OCCASIONS_MOBILE = [
  ...
  OCCASIONS_DESKTOP[4], // Spumanti
  OCCASIONS_DESKTOP[5], // Vini Bianchi
];
